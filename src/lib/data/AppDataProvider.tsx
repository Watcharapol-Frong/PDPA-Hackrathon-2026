 ...
 * เปลี่ยนแหล่งข้อมูลได้ที่ getDataSource() ที่เดียว — ไม่ต้องแตะ UI component ใด ๆ
 * ใช้ Suspense (`use`) เพื่อให้พร้อมรับแหล่งข้อมูลแบบ async ในอนาคตโดยไม่ต้องเขียนใหม่
 */
